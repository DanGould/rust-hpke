...
// pub(crate) mod dhsecp256k1_hkdfsha256 {
//     use crate::{
...
//     type PublicKey = bitcoin::secp256k1::PublicKey;
//     type PrivateKey = bitcoin::secp256k1::PrivateKey;
...
//     #[doc(hidden)]
//     #[derive(Clone)]
//     pub struct EncappedKey(pub(crate) bitcoin::secp256k1::PublicKey);
...
//         type OutputSize = <bitcoin::secp256k1::PublicKey as Serializable>::OutputSize;
...
//             let pubkey =
//                 <bitcoin::secp256k1::PublicKey as Deserializable>::from_bytes(encoded)?;
...
//         sk_eph: PrivateKey,
//     ) -> Result<(bitcoin::secp256k1::ecdh::SharedSecret, EncappedKey), HpkeError> {
...
//         let kex_res_eph = SharedSecret::new(&sk_eph, pk_recip)
//             .map_err(|_| HpkeError::EncapError)?;

//         // The encapped key is the ephemeral pubkey
//         let encapped_key = {
//             let pk_eph = PublicKey::from_secret_key(&sk_eph);
//             EncappedKey(pk_eph)
//         };
...
//             let kex_res_identity = SharedSecret::new(sk_sender_id, pk_recip)
//                 .map_err(|_| HpkeError::EncapError)?;
...
//             secp.generate_keypair(/*(randomness) */)
//         }
...
//             // Compute the shared secret from the ephemeral inputs
//             let kex_res_eph = SharedSecret::new(sk_recip, &encapped_key.0)
//                 .map_err(|_| HpkeError::DecapError)?;

//             // Compute the sender's pubkey from their privkey
//             let pk_recip = SecretKey::sk_to_pk(sk_recip);
...
// #[cfg(feature = "k256")]
// impl_dhkem!(
//     dhk256_hkdfsha256, // mod
//     DhK256HkdfSha256, // struct
//     crate::dhkex::ecdh_nist::k256::DhK256, // nist_dhkex defined ECDH functionalities
//     crate::kdf::HkdfSha256, // HKDF
//     0x0016,                                 // IANA KEM ID value https://www.iana.org/assignments/hpke/hpke.xhtml
//     "Represents DHKEM(K-256, HKDF-SHA256)" // Description
// );
